...
df_real = pd.read_csv('final_result_nx0.5_1_1_1.csv')

df_test = pd.read_csv('final_result_nx0.5_10_1_0.csv')

df_test1 = pd.read_csv('final_result_nx0.5_10_1_1.csv')

df_test2 = pd.read_csv('final_result_nx0.5_2_1_0.csv')
