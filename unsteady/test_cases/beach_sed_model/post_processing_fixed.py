...
df_test3 = pd.read_csv('final_result_nx0.75_ny1.0.csv')

df_test4 = pd.read_csv('final_result_nx0.5_ny1.0.csv')

df_test5 = pd.read_csv('final_result_nx0.25_ny1.0.csv')
df_test6 = pd.read_csv('final_result_nx0.25_0_1_1.csv')
