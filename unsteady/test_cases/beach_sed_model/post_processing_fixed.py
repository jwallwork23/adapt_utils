...
df_real = pd.read_csv('final_result_nx4.0_ny2.csv')

df_test = pd.read_csv('final_result_nx2.0_ny1.csv')

df_test1 = pd.read_csv('final_result_nx1.5_ny1.csv')

df_test2 = pd.read_csv('final_result_nx1.0_ny1.csv')

df_test3 = pd.read_csv('final_result_nx0.75_ny1.csv')

df_test4 = pd.read_csv('final_result_nx0.5_ny1.csv')

df_test5 = pd.read_csv('final_result_nx0.25_ny1.csv')
