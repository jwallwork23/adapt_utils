...
bath_orig0 = Function(bath0.function_space()).interpolate(Constant(220/40) - x/40)

x, y = SpatialCoordinate(bath1.function_space().mesh())
bath_orig1 = Function(bath1.function_space()).interpolate(Constant(220/40) - x/40)

x, y = SpatialCoordinate(bath2.function_space().mesh())
bath_orig2 = Function(bath2.function_space()).interpolate(Constant(220/40) - x/40)
