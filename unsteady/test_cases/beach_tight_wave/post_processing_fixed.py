...
df_real = pd.read_csv('final_result_nx1_ny1.csv')

#df_test = pd.read_csv('final_result_nx2.0_ny2.0.csv')

#df_test1 = pd.read_csv('final_result_nx1.5_ny1.0.csv')

#df_test2 = pd.read_csv('final_result_nx1.0_ny1.0.csv')

df_test3 = pd.read_csv('final_result_nx0.75_ny1.csv')

df_test4 = pd.read_csv('final_result_nx0.5_ny0.5.csv')

df_test5 = pd.read_csv('final_result_nx0.25_ny0.5.csv')

df_test6 = pd.read_csv('final_result_nx0.2_ny0.5.csv')
...
error_list.append(sum([(df_test6['bath'][i] - df_real['bath'][i])**2 for i in range(1, len(df_real))]))
print(error_list)
