...
axes.plot(time_hours, left_hand_forcing(time_seconds), label="Left hand boundary")
axes.plot(time_hours, right_hand_forcing(time_seconds), label="Right hand boundary")
...
r = op.T_ramp/3600
axes.annotate("", xy=(-r, -0.53), xytext=(0.0, -0.53), annotation_clip=False, **plotting_kwargs)
axes.annotate("Spin-up period", xy=(-0.65*r, -0.56), xytext=(-0.65*r, -0.56), annotation_clip=False)
